    ...
    <main class="flex-1">
        <section class="dashboard-section">
            <div class="container">
                ...
                <!-- Add New Order Form -->
                <div class="form-container">
                    <h3 class="text-2xl font-semibold mb-4">Add New Order (Existing Parts)</h3>
                    <form action="add_stock_order.php" method="post">
                        ...
                        <select name="customer_id" required>
                            ...
                            <?php foreach ($customers as $customer): ?>
                                <option value="<?php echo htmlspecialchars($customer['id']); ?>">
                                    <?php echo htmlspecialchars($customer['id'] . ' - ' . $customer['email']); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                        <select name="part_id" required>
                            ...
                            <?php foreach ($inventory_parts as $part): ?>
                                <option value="<?php echo htmlspecialchars($part['part_id']); ?>">
                                    <?php echo htmlspecialchars($part['part_name'] . ' (Warehouse ID: ' . $part['warehouse_id'] . ')'); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                        <input type="number" name="quantity" placeholder="Quantity" min="1" required>
                ...
                <!-- Add New Part to Order Form -->
                <div class="form-container">
                    <h3 class="text-2xl font-semibold mb-4">Add New Part to Order</h3>
                    <form action="add_stock_order.php" method="post">
                        <input type="hidden" name="action" value="add_new_part_order">
                        <select name="customer_id" required>
                            <option value="">Select Customer</option>
                            <?php foreach ($customers as $customer): ?>
                                <option value="<?php echo htmlspecialchars($customer['id']); ?>">
                        ...
                        <input type="text" name="part_name" placeholder="New Part Name" required>
                        <input type="number" name="quantity" placeholder="Quantity" min="1" required>
                        <input type="number" name="unit_price" placeholder="Unit Price (ZMW)" min="0" step="0.01" required>
                        <select name="warehouse_id" required>
                            <option value="">Select Warehouse</option>
                        ...
                        <button type="submit">Add Part and Order</button>
                    </form>
                </div>
