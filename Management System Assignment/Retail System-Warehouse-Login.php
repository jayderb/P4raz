...
// Check if the user is already logged in, if yes redirect to warehouse dashboard
if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true && isset($_SESSION["role"])) {
    if ($_SESSION["role"] === 'warehouse') {
        ...
        // If role is not warehouse, log out and redirect
        session_unset();
        session_destroy();
        header("location: Retail System-Warehouse-login.php?error=invalid_role");
        exit;
    }
}
...
<head>
    ...
    <title>ZedAuto - Warehouse Login</title>
    <!-- Favicon -->
    ...
    <div class="main-content">
        <div class="video-container">
            <video autoplay muted loop id="video">
                <source src="./Static/Videos/warehouse.mp4" type="video/mp4">
                Your browser does not support HTML5 video.
            </video>
        </div>

        <div class="login-container">
            <form id="loginForm" action="warehouse-authenticate.php" method="post">
                ...
                <input type="email" name="email" id="email" class="email" placeholder="Enter your email" required aria-label="Enter your warehouse email address">

                <?php if (!empty($password_err)): ?>
                    <div class="error-message"><?php echo $password_err; ?></div>
                <?php endif; ?>
                <label for="password">Password:</label>
                <input type="password" name="password" id="password" class="password" placeholder="Enter your password" required aria-label="Enter your password">
